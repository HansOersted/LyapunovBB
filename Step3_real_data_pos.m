...
%% Load the errors from Simulink

e_interested = out.e.signals.values(:,1);
de_interested = out.de.signals.values(:,1);
dde_interested = out.dde.signals.values(:,1);
